...
function App() {
  ...
  useEffect(() => {
    ...
    const mockData = [
      // { id: '001', name: 'John Doe', email: 'john@example.com', timestamp: '2025-06-28T10:30:00Z' },
      // { id: '002', name: 'Jane Smith', email: 'jane@example.com', timestamp: '2025-06-28T11:15:00Z' },
      // { id: '003', name: 'Mike Johnson', email: 'mike@example.com', timestamp: '2025-06-28T12:00:00Z' },
    ];
    setSubmittedData(mockData);
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Add new submission to the display list
        const newSubmission = {
          id: formData.ids,
          name: formData.name,
          email: formData.mail,
        ...
        setSubmittedData(prev => [newSubmission, ...prev]);
      } else {
